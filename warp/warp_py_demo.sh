...
python python_scripts/create_embedding_file.py $output/warp_py_B.txt $data/type.txt $output/warp_B.bin
python python_scripts/create_embedding_file.py $output/warp_py_A.txt $data/feature.txt $output/warp_A.bin
